    ...
    supabase
      ...
      .select(`
        ...
        subcategories (
          ...
          options ( id, slug, name, price, prompt_descriptor, dimensions, swatch_url, swatch_color, nudge, sort_order, floorplan_ids, generation_rules, is_default, scoped_edit_model, linked_to_subcategory )
        )
      `)
      .eq("org_id", orgId)
      .order("sort_order"),
