        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p>
              ...
              your purchase agreement. Plan for 2 to 4 hours, depending on
              your floor plan and how many options your community offers.
            ...
            <p>
              ...
              every category, shows you physical samples, and helps you see how
            ...
            <p>
              Everything starts at &quot;included.&quot; Each category has a
      ...
      <Section id="priorities">
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p>
              <strong className="text-slate-900">Do it now:</strong>{" "}
            ...
            <p>
              <strong className="text-slate-900">Can wait:</strong>{" "}
