  ...
  return (
    <div className="border border-gray-200 overflow-hidden">
      <button
        ...
        className="w-full flex items-center justify-between p-4 bg-white hover:bg-gray-50 transition-colors duration-150 cursor-pointer"
      >
        <div className="flex items-center gap-3">
          ...
          {hasVisual && (
            <span className="text-[10px] font-medium text-[var(--color-accent)] bg-blue-50 px-2 py-0.5 border border-blue-200">
              Visual
            </span>
          )}
        </div>
