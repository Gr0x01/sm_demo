                ...
                <div className="w-full aspect-square bg-gray-100 overflow-hidden relative">
                  ...
                  {hasVisual && (
                    <div
                      ...
                      className="absolute bottom-1 right-1 w-6 h-6 bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-150 cursor-pointer hover:bg-black/70 active:scale-90"
