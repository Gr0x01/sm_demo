...
const ROOM_PHOTO_SPATIAL_HINTS: Record<string, string> = {
  ...
  "greatroom-wide.webp":
    "Great room is foreground, kitchen is background. The fireplace is mostly out of frame — only a small sliver of hearth brick is visible at the extreme bottom-left corner. Do NOT draw, add, or enlarge the fireplace; only change the material/color of the small brick area already visible at the bottom-left edge. Trim, paint, and flooring are the primary editable surfaces in the living area; kitchen cabinetry remains separate unless explicitly selected. Keep chandelier/fan positions and room layout unchanged.",
